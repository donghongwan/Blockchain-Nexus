...
@router.delete("/cancel_transaction/{transaction_id}")
async def cancel_transaction(transaction_id: str, token: str = Depends(oauth2_scheme)):
    # Logic to cancel a transaction
    return {"message": f"Transaction {transaction_id} has been canceled."}
