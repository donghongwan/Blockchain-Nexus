# src/banks/citibank_api.py

import requests

class CitibankAPI:
    def __init__(self, api_key, base_url="https://api.citibank.com/v1"):
...
if __name__ == "__main__":
    citibank_api = CitibankAPI(api_key="YOUR_API_KEY")
    account_id = "123456789"

    try:
        balance = citibank_api.get_account_balance(account_id)
        print("Account Balance:", balance)

        transactions = citibank_api.get_transaction_history(account_id)
